...
const artist_data=[
    ...
    },
    {
        ...
        인스타그램: "https://www.instagram.com/andmarq_official/",
        상세정보: `
            정동훈은 영화 <청년경찰>, <롱 리브 더 킹: 목포 영웅>, 드라마 <슬기로운 감빵생활>, <아스달 연대기> 등 다양한 작품에 출연하며 대중에게 존재감을 알리기 시작했다. 단단한 눈빛과 안정적인 연기력으로 출연하는 작품마다 자신만의 고유한 캐릭터를 표현해내고 있는 그는 앞으로가 더욱 기대되는 차세대 배우로 주목받고 있다. 차근차근 필모그래피를 쌓아가며 매 작품이 끝날 때마다 “이 작품으로 인해 크게 성장할 수 있었다”고 말하며 기대감을 불러일으키고 있는 정동훈은 앞으로도 한계 없는 연기 스펙트럼을 펼칠 예정이다.
        `,
        드라마: `
            2022 디즈니+ 커넥트^2022 ENA 신병^2021 tvN 지리산^2019 tvN 아스달 연대기^2018 OCN 작은 신의 아이들
        `,
        영화: `
            2022 사잇소리^2019 롱 리브 더 킹: 목포 영웅^2017 청년경찰^2016 방석
        `,
        수상내역: ``
    },
]
